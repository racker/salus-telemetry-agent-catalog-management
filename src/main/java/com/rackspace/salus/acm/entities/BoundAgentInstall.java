...
package com.rackspace.salus.acm.entities;
...
public class BoundAgentInstall {
  ...
  public BoundAgentInstallDTO toDTO() {
    final AgentRelease release = agentInstall.getAgentRelease();

    return new BoundAgentInstallDTO()
        .setResourceId(resourceId)
        .setAgentInstall(agentInstall.toDTO());
  }
}
